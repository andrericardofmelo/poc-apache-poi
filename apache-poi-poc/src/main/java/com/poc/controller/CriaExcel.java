 ...
 * @author andre.melo
 * @Date 14/12/2018
 * @description Classe responsável por criar um arquivo excel e popular as
 *              informações do objeto aluno.
 *
 */
...
public class CriaExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		// Cria uma nova planilha (Folha).
		HSSFSheet sheetAlunos = workbook.createSheet("Alunos");

		// Carrega a lista de alunos para popular o arquivo.
		...
		// Percorre a lista de alunos e popula as informações nas linhas.
